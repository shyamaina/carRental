              ...
              <Col>
                <Row>
                  ...
                  <Col>
                    ...
                    <p className="fs-6 text-white m-0">Find all the essential details you need for a smooth rental experience, including vehicle options, pricing, and rental policies. Our customer support team is always here to assist with any questions.

</p>
                  </Col>
                  <Col>
                    <h4 className="fs-4 text-white fw-700">Helpful Links</h4>
                    <p className="fs-6 text-white m-0">Explore useful links for quick access to vehicle booking, rental terms, FAQs, and customer support. Our resources are designed to make your experience easier and more convenient.
                  ...
                  <span>
                    ...
                    <a href="https://goo.gl/maps/2rkkAA9FP5pegCXF9" target="_blank" className="text-white">Hyderabad</a>
                  </span>
                      <br/>
                      <span>
                    <BsTelephoneFill size="0.9em" className="header-line-2-icon"/>&nbsp;
                        <a href="tel:+12126583916" target="_blank" className="text-white">(+91) 8143635201</a>
                  </span>
                      <br/>
                      <span>
                    <GrMail className="header-line-2-icon"/>&nbsp;
                        <a href="mailto:fbatuhanr@gmail.com" target="_blank" className="text-white">carrental@gmail.com</a>
                  </span>
                    </p>
            ...
            <Row>
              <Col>
                <p className="text-white text-center fs-6 mt-2 mb-1">
                  ...
                  <a href="https://github.com/fbatuhanr/" target="_blank" className="text-primary">Eshwar</a>
                </p>
              </Col>
            </Row>
          </Container>
